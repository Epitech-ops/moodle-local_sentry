...
$string['replays_sample_rate']  = 'Replays Sample Rate';
$string['replays_session_sample_rate'] = 'Replays Session Sample Rate';
$string['replays_on_error_sample_rate'] = 'Replays On Error Sample Rate';
...
$string['replays_sample_rate_desc'] = 'The sample rate for replays sent to Sentry. A value of 1.0 means all replays are sent, while a value of 0.1 means 10% of replays are sent.';
$string['replays_session_sample_rate_desc'] = 'The sample rate for replays of sessions sent to Sentry. A value of 1.0 means all session replays are sent, while a value of 0.1 means 10% of session replays are sent.';
$string['replays_on_error_sample_rate_desc'] = 'The sample rate for replays sent to Sentry when an error occurs. A value of 1.0 means all error replays are sent, while a value of 0.1 means 10% of error replays are sent.';
