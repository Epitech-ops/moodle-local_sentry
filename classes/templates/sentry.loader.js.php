...
(function(
  ...
  })(window, document, 'script', 'onerror', 'onunhandledrejection', 'Sentry', 'sentry.loader.js', '<?php echo $sentry_bundle_js_url; ?>', {
    dsn: '<?php echo $sentry_relay_dsn; ?>',
    release: '<?php echo $build_version; ?>',
