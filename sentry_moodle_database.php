...
class sentry_moodle_database extends moodle_database {
    ...
    public function __destruct() {
		...
		public function new_span($op) {
				...
				unset($backtrace[count($backtrace)-1]); // Unset this function
				$spanCtx->setData([
     ...
     * @return sentry_moodle_database driver object or null if error, for example of driver object see {@link mysqli_native_sentry_moodle_database}
     */
		public static function get_driver_instance($type, $library, $external = false) {
				return $this->db->get_driver_instance($type, $library, $external = false);
    }
     ...
     */
		public function connect($dbhost, $dbuser, $dbpass, $dbname, $prefix, array $dboptions=null){
				$span = $this->new_span('connect');
				return $this->db->connect($dbhost, $dbuser, $dbpass, $dbname, $prefix, $dboptions);
				$this->finish_span($span);
		}
     ...
     */
		public function get_in_or_equal($items, $type=SQL_PARAMS_QM, $prefix='param', $equal=true, $onemptyitems=false) {
				$span = $this->new_span('get_in_or_equal');
    ...
    protected function add_sql_debugging(string $sql): string {
        ...
        $callers = array_filter($callers, function($caller) {
            return empty($caller['class']) || $caller['class'] != 'sentry_moodle_database';
        });
     ...
     */
		public function get_columns($table, $usecache = true): array {
				$span = $this->new_span('get_columns');
				return $this->db->get_columns($table, $usecache);
				$this->finish_span($span);
    }
     ...
     */
		protected function fetch_columns(string $table): array {
				$span = $this->new_span('fetch_columns');
     ...
     */
		public function get_recordset($table, array $conditions=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_recordset');
				return $this->db->get_recordset($table, $conditions, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_recordset_list($table, $field, array $values, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_recordset_list');
				return $this->db->get_recordset_list($table, $field, $values, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_recordset_select($table, $select, array $params=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_recordset_select');
				return $this->db->get_recordset_select($table, $select, $params, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_recordset_sql($sql, array $params=null, $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_recordset_sql');
				return $this->db->get_recordset_sql($sql, $params, $limitfrom, $limitnum);
				$this->finish_span($span);
		}
     ...
     */
		public function get_records($table, array $conditions=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records');
				return $this->db->get_records($table, $conditions, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_records_list($table, $field, array $values, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
			$span = $this->new_span('get_records_list');
			return $this->db->get_records_list($table, $field, $values, $sort, $fields, $limitfrom, $limitnum);
			$this->finish_span($span);
    }
     ...
     */
		public function get_records_select($table, $select, array $params=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records_select');
				return $this->db->get_records_select($table, $select, $params, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_records_sql($sql, array $params=null, $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records_sql');
     ...
     */
		public function get_records_menu($table, array $conditions=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records_menu');
				return $this->db->get_records_menu($table, $conditions, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_records_select_menu($table, $select, array $params=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records_select_menu');
				return $this->db->get_records_select_menu($table, $select, $params, $sort, $fields, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_records_sql_menu($sql, array $params=null, $limitfrom=0, $limitnum=0) {
				$span = $this->new_span('get_records_sql_menu');
				return $this->db->get_records_sql_menu($sql, $params, $limitfrom, $limitnum);
				$this->finish_span($span);
    }
     ...
     */
		public function get_record($table, array $conditions, $fields='*', $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_record');
				return $this->db->get_record($table, $conditions, $fields, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_record_select($table, $select, array $params=null, $fields='*', $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_record_select');
				return $this->db->get_record_select($table, $select, $params, $fields, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_record_sql($sql, array $params=null, $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_record_sql');
				return $this->db->get_record_sql($sql, $params, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_field($table, $return, array $conditions, $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_field');
				return $this->db->get_field($table, $return, $conditions, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_field_select($table, $return, $select, array $params=null, $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_field_select');
				return $this->db->get_field_select($table, $return, $select, $params, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_field_sql($sql, array $params=null, $strictness=IGNORE_MISSING) {
				$span = $this->new_span('get_field_sql');
				return $this->db->get_field_sql($sql, $params, $strictness);
				$this->finish_span($span);
    }
     ...
     */
		public function get_fieldset_select($table, $return, $select, array $params=null) {
				$span = $this->new_span('get_fieldset_select');
				return $this->db->get_fieldset_select($table, $return, $select, $params);
				$this->finish_span($span);
    }
     ...
     */
		public function get_fieldset_sql($sql, array $params=null) {
				$span = $this->new_span('get_fieldset_sql');
     ...
     */
		public function insert_record_raw($table, $params, $returnid=true, $bulk=false, $customsequence=false) {
				$span = $this->new_span('insert_record_raw');
				return $this->db->insert_record_raw($table, $params, $returnid, $bulk, $customsequence);
				$this->finish_span($span);
		}
     ...
     */
		public function insert_record($table, $dataobject, $returnid=true, $bulk=false) {
				$span = $this->new_span('insert_record');
				return $this->db->insert_record($table, $dataobject, $returnid, $bulk);
				$this->finish_span($span);
		}
     ...
     */
		public function insert_records($table, $dataobjects) {
				$span = $this->new_span('insert_records');
				return $this->db->insert_records($table, $dataobjects);
				$this->finish_span($span);
    }
     ...
     */
		public function import_record($table, $dataobject) {
				$span = $this->new_span('import_record');
				return $this->db->import_record($table, $dataobject);
				$this->finish_span($span);
		}
     ...
     */
		public function update_record_raw($table, $params, $bulk=false) {
				$span = $this->new_span('update_record_raw');
				return $this->db->update_record_raw($table, $params, $bulk);
				$this->finish_span($span);
		}
     ...
     */
		public function update_record($table, $dataobject, $bulk=false) {
				$span = $this->new_span('update_record');
				return $this->db->update_record($table, $dataobject, $bulk);
				$this->finish_span($span);
		}
     ...
     */
		public function set_field($table, $newfield, $newvalue, array $conditions=null) {
				$span = $this->new_span('set_field');
				return $this->db->set_field($table, $newfield, $newvalue, $conditions);
				$this->finish_span($span);
    }
     ...
     */
		public function set_field_select($table, $newfield, $newvalue, $select, array $params=null) {
				$span = $this->new_span('set_field_select');
				return $this->db->set_field_select($table, $newfield, $newvalue, $select, $params);
				$this->finish_span($span);
		}
     ...
     */
		public function count_records($table, array $conditions=null) {
				$span = $this->new_span('count_records');
     ...
     */
		public function count_records_select($table, $select, array $params=null, $countitem="COUNT('x')") {
				$span = $this->new_span('count_records_select');
				return $this->db->count_records_select($table, $select, $params, $countitem);
				$this->finish_span($span);
    }
     ...
     */
		public function count_records_sql($sql, array $params=null) {
				$span = $this->new_span('count_records_sql');
     ...
     */
		public function record_exists($table, array $conditions) {
				$span = $this->new_span('record_exists');
     ...
     */
		public function record_exists_select($table, $select, array $params=null) {
				$span = $this->new_span('record_exists_select');
				return $this->db->record_exists_select($table, $select, $params);
				$this->finish_span($span);
    }
     ...
     */
		public function record_exists_sql($sql, array $params=null) {
				$span = $this->new_span('record_exists_sql');
     ...
     */
		public function delete_records($table, array $conditions=null) {
				$span = $this->new_span('delete_records');
     ...
     */
		public function delete_records_list($table, $field, array $values) {
				$span = $this->new_span('get_in_or_equal');
				return $this->db->delete_records_list($table, $field, $values);
				$this->finish_span($span);
    }
    ...
    public function delete_records_subquery(string $table, string $field, string $alias,
			string $subquery, array $params = []): void {
				$span = $this->new_span('delete_records_subquery');
				$this->db->delete_records_subquery($table, $field, $alias, $subquery, $params);
				$this->finish_span($span);
    }
     ...
     */
		public function delete_records_select($table, $select, array $params=null) {
				$span = $this->new_span('delete_records_select');
				return $this->db->delete_records_select($table, $select, $params);
				$this->finish_span($span);
		}
     ...
     */
		public function replace_all_text($table, database_column_info $column, $search, $replace) {
				$span = $this->new_span('replace_all_text');
				return $this->db->replace_all_text($table, $column, $search, $replace);
				$this->finish_span($span);
    }
