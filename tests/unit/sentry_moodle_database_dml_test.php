...
/**
 * DML layer tests for sentry_moodle_database.
 *
...
define('TEST_FIXTURES_LOCATION', __DIR__ . '/../../../../lib/dml/tests/fixtures');
 ...
 */
class sentry_moodle_database_dml_test extends \database_driver_testcase {
...
-- line 517 of /local/sentry/tests/unit/sentry_moodle_database_dml_test.php: call to test_dml_sql_debugging_fixture->four()
EOD;
        $this->assertEquals($this->unix_to_os_dirsep($expected), $out);
    ...
    public function test_execute() {
        ...
        $course = 9999;
        $onetext = file_get_contents(TEST_FIXTURES_LOCATION . '/clob.txt');
        ...
        $newcourse = 10000;
        $newonetext = file_get_contents(TEST_FIXTURES_LOCATION . '/clob.txt') . '- updated';
    ...
    public function test_insert_record() {
        ...
        $clob = file_get_contents(TEST_FIXTURES_LOCATION . '/clob.txt');
        $blob = file_get_contents(TEST_FIXTURES_LOCATION . '/randombinary');
        $record = new \stdClass();
        $record->onetext = $clob;
